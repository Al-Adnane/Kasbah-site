'use strict';
// ═══════════════════════════════════════════════════════════════════
//  Kasbah Guard — Market Launch Stress Test  v1.0.0
//
//  Sections:
...
if (ev === '1.0.0') { passed++; console.log('  \u2705 [F04] SDK ENGINE_VERSION = "' + ev + '"'); }
else { failed++; failures.push({id:'F04',label:'SDK ENGINE_VERSION',expected:'1.0.0',got:ev||'?'}); console.log('  \u274c [F04] SDK ENGINE_VERSION = "' + ev + '"'); }

// F05: VS Code EXPECTED_ENGINE = 1.0.0
total++;
...
if (ee === '1.0.0') { passed++; console.log('  \u2705 [F05] VS Code EXPECTED_ENGINE = "' + ee + '"'); }
else { failed++; failures.push({id:'F05',label:'VS Code EXPECTED_ENGINE',expected:'1.0.0',got:ee||'?'}); console.log('  \u274c [F05] VS Code EXPECTED_ENGINE = "' + ee + '"'); }
