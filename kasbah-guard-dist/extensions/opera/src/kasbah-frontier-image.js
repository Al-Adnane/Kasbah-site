...
(function (global) {
  ...
  var FRONTIER_IMAGE = (function () {
    ...
    var PR={'stable-diffusion':[0.30,0.40,0.35,0.40],'dall-e':[0.25,0.35,0.30,0.20],'midjourney':[0.20,0.30,0.25,0.30],'stylegan3':[0.35,0.45,0.40,0.55],'flux':[0.28,0.38,0.33,0.25]},NP=[0.10,0.80,0.10,0.05];
